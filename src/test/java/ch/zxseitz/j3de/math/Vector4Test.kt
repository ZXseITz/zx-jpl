...
class Vector4Test {
    ...
    fun testAdd() {
        ...
        assertEquals(Vector4(6f, 8f, 10f, 12f), a + b)
    }
    ...
    fun testSubtract() {
        ...
        assertEquals(Vector4(-4f, -4f, -4f, -4f), a - b)
    }
    ...
    fun testMultiply() {
        ...
        assertEquals(Vector4(5f, 12f, 21f, 32f), a _times b)
    }
    ...
    fun testScale() {
        ...
        assertEquals(Vector4(5f, 10f, 15f, 20f), a * s)
    }
    ...
    fun testPerspectiveDivision() {
        ...
        assertEquals(Vector3(4f, 2f, 3f), a.persDiv())
    }
}
